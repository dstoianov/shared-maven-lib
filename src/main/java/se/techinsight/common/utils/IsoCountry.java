package se.techinsight.common.utils;
...
public final class IsoCountry implements Serializable {
    ...
    static {
        ...
        ISO2_TO_DISPLAY_COUNTRY = Collections.unmodifiableMap(
                Arrays.stream(countries).collect(Collectors.toMap(
                        iso2 -> iso2.intern(),
     ...
     *
     * @param countryCode 2 or 3 character country code, case sensitive (examples "US", "USA")
     ...
     *
     * @param displayCountry the display country name, e.g. "United States"
     ...
     *
     * @param isoCountry 2 or 3 character country code, case sensitive (examples "US", "USA")
     ...
     *
     * @param iso3 3 character country code, case sensitive (example "USA")
     ...
     *
     * @param iso2 2 character country code, case sensitive (example "US")
